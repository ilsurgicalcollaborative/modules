<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IntroModuleHTML5.aspx.cs" Inherits="ISQICData.Modules.intro.IntroModuleHTML5" %>
...
<div style="width:600px;height:550px;"> <%--Added this div to contain HTML from Articulate Storyline within existing header and footer--%>
...
<script>
    ...
    var globals = {};
    try {
        globals.strTitle = "Introduction to ISQIC";
        globals.bLMS = false;

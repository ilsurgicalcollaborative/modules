<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FMEAModuleHTML5.aspx.cs" Inherits="ISQICData.Modules.FMEA.FMEAModuleHTML5" %>
...
<div style="width:600px;height:500px;"> <%--Added this div to contain HTML from Articulate Storyline within existing header and footer--%>
    <div class="interstitial white"></div>
	<span id="loadingSpinner" class="loading"></span>

	<div class="framewrap" style="position:relative;margin-top:-100px;margin-left:-200px;padding-top:-20px;"><%--Added style here to position HTML from Articulate Storyline--%>
...
<script>
    ...
    var globals = {};
    try {
        globals.strTitle = "Failure Modes Effects Analysis";
        globals.bLMS = false;

<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AnalyzeModule.aspx.cs" Inherits="ISQICData.Modules.analyze.AnalyzeModule" %>
...
object {outline: none;}
    ...
    <%----%>
    <div style="width:600px;margin-left:auto;margin-right:auto;padding-top:30px;padding-bottom:20px;"><asp:Button CssClass="ISQICButton" ID="btnReturn" runat="server" 
    ...
    <script type="text/javascript">
        ...
        if (g_bRedirectAMP) {
            ...
            var strLocation = "AnalyzeModuleHTML5.aspx";

<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AnalyzeModuleHTML5.aspx.cs" Inherits="ISQICData.Modules.analyze.AnalyzeModuleHTML5" %>
...
<style>
/*body { margin:0;}z-index:10;visibility:visible;*/ 
object {outline: none;}
</style>
    <script>
    ...
    <%----%>
    <div style="width:600px;margin-left:auto;margin-right:auto;padding-top:30px;padding-bottom:30px;"><asp:Button CssClass="ISQICButton" ID="btnReturn" runat="server" 
        Text="Click here to Record Module Completion and Return to Module Menu" OnClick="btnReturn_Click" style="display:none;" ForeColor="Red" Font-Bold="True" Font-Size="Medium"  /></div>

<div style="width:600px;height:500px;margin-top:20px;"> <%--Added this div to contain HTML from Articulate Storyline within existing header and footer--%>
    <div class="interstitial white"></div>
	<span id="loadingSpinner" class="loading"></span>

	<div class="framewrap" style="position:relative;margin-top:-150px;margin-left:-200px;padding-top:-10px;"><%--Added style here to position HTML from Articulate Storyline--%>
...
<script>
    ...
    var globals = {};
    try {
        globals.strTitle = "DMAIC: Analyze";
        globals.bLMS = false;
    ...
    $("#miModules").addClass("SelectedMenuListItem");
    $("#liProcess").hide();
</script>

    <p><asp:Label ForeColor="Red" ID="lblMsg" runat="server" Text="" ></asp:Label></p>
    <%--<DIV id='divEmail' style="position: absolute; width: 10; height: 10; left: 10; top: 10; visibility:hidden" ></DIV>--%>

    <DIV id='divWebObjects' style="z-index:999;position:relative;width:300px;height:330px;left:0px;top:-1100px;visibility:visible;"></DIV>

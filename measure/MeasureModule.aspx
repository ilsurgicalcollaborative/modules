<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MeasureModule.aspx.cs" Inherits="ISQICData.Modules.measure.MeasureModule" %>
...
object {outline: none;}
    ...
    <script type="text/javascript">
        ...
        if (g_bRedirectAMP) {
            ...
            var strLocation = "MeasureModuleHTML5.aspx";
    ...
    <DIV id='divWebObjects' style="z-index:999;position:relative;width:500px;height:40px;left:0px;top:-830px;visibility:visible;"></DIV>

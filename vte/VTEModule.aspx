<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VTEModule.aspx.cs" Inherits="ISQICData.Modules.VTE.VTEModule" %>
...
object {outline: none;}
    ...
    <div style="width:600px;margin-left:auto;margin-right:auto;padding-top:10px;padding-bottom:10px;"><asp:Button CssClass="ISQICButton" ID="btnReturn" runat="server" 
    ...
    <p class="WarningMessage" style="display:none;color:red;font-weight:800;">The VTE module does not run on Chrome or other browsers that do not support Flash.  Please use another browser.</p>
    ...
    <p><asp:Label CssClass="WarningMessage" ForeColor="Red" ID="lblMsg" runat="server" Text="" ></asp:Label></p>
     <%--<DIV id='divEmail' style="position: absolute; width: 10; height: 10; left: 10; top: 10; visibility:hidden" ></DIV>--%>

    <DIV id='divWebObjects' style="z-index:999;position:relative;width:300px;height:10px;left:0px;top:-1100px;visibility:visible;"></DIV>

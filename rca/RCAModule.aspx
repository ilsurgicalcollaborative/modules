<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RCAModule.aspx.cs" Inherits="ISQICData.Modules.RCA.RCAModule" %>
...
object {outline: none;}
    ...
    <div style="width:650px;margin-left:auto;margin-right:auto;padding-top:30px;padding-bottom:30px;"><asp:Button CssClass="ISQICButton" ID="btnReturn" runat="server" 
    ...
    <script type="text/javascript">
        ...
        if (g_bRedirectAMP) {
            ...
            var strLocation = "RCAModuleHTML5.aspx";

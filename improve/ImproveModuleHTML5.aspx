<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImproveModuleHTML5.aspx.cs" Inherits="ISQICData.Modules.improve.ImproveModuleHTML5" %>
...
object {outline: none;}
    ...
    <div style="width:600px;margin-left:auto;margin-right:auto;padding-top:30px;padding-bottom:10px;"><asp:Button CssClass="ISQICButton" ID="btnReturn" runat="server" 
...
<script>
    ...
    var globals = {};
    try {
        globals.strTitle = "DMAIC: Improve";
        globals.bLMS = false;

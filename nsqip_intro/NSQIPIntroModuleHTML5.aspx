<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSQIPIntroModuleHTML5.aspx.cs" Inherits="ISQICData.Modules.nsqip_intro.NSQIPIntroModuleHTML5" %>
...
<div style="width:600px;height:650px;"> <%--Added this div to contain HTML from Articulate Storyline within existing header and footer--%>

<div style="width:600px;margin-left:auto;margin-right:auto;padding-bottom:30px;"><asp:Button CssClass="ISQICButton" ID="btnReturn" runat="server" 
...
<script>
    ...
    var globals = {};
    try {
        globals.strTitle = "Introduction to NSQIP";
        globals.bLMS = false;

<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSQIPIntroModule.aspx.cs" Inherits="ISQICData.Modules.nsqip_intro.NSQIPIntroModule" %>
...
<script type="text/javascript">
    ...
    if (g_bRedirectAMP) {
        ...
        var strLocation = "NSQIPIntroModuleHTML5.aspx";
...
<script type="text/javascript">
    ...
    <DIV id='divWebObjects' style="z-index:999;position:relative;width:500px;height:40px;left:0px;top:-880px;visibility:visible;"></DIV>
